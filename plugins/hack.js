...
async (conn, mek, m, { from, quoted, reply }) => {
    try {
        const steps = [
            '🖥️ *INITIALIZING QUEEN SACHI-MD HAVK  ENGINE...* 📡',
            '',
        ...
        await conn.sendMessage(from, {
            ...
            footer: "QUEEN SACHI-MD - The Bot That Knows Fun! 🤖",
            headerType: 1
        });
