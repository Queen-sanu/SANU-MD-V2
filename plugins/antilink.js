...
cmd({
  ...
  try {
    ...
    if (!q) {
      return reply('Please provide a YouTube URL or song name. Example: `.play https://youtube.com/...` or `.play Believer`');
    }
    ...
    await reply(`🎵 *QUEEN SACHI-MD Downloading ${songDetails.title}...*`);
