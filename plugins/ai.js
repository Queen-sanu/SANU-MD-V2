...
cmd({
    ...
    try {
        ...
        // Image AI à envoyer
        const ALIVE_IMG = 'https://i.ibb.co/SwSMnV9V/6e06f7fc2127.jpg'; // Remplacez par l'URL de votre image AI
...
cmd({
    ...
    try {
        ...
        // AI image to attach
        const AI_IMG = 'https://i.ibb.co/SwSMnV9V/6e06f7fc2127.jpg'; // Replace with a valid image URL
